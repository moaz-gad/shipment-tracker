        ...
        <Container>
          ...
          <Navbar.Collapse id="navbarScroll">
            ...
            >
              ...
              <Nav.Link href="/">{t("header.Pricing")}</Nav.Link>
              <Nav.Link href="/">{t("header.ContactSales")}</Nav.Link>
            </Nav>
            ...
            <Form className="d-flex">
              <Nav
                ...
                navbarScroll
              >
                <Nav.Link href="/">{t("header.TrackingShipment")}</Nav.Link>

                <Nav.Link href="/">{t("SignIn")}</Nav.Link>
